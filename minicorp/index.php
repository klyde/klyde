...
<section id="part-lead" class="part-lead lead-boxed" style="background-color:#ac984d;border-top: 5px solid #554335;margin-top: 1px;padding-top: 25px;">
    <div class="row">
        <section class="grid12">
            <h1 class=" color4 acenter"><?php single_post_title(); ?></h1>
            <span class="lead-description" style="text-align:center !important;display: block;font-size:14px;">Change this in the index.php template to something clever!
            </span>
        </section>
    </div>
</section>
