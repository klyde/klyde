            ...
            <div class="lined-section-only" style="white-space: nowrap;"><span style=""></span></div>
                ...
                <?php
                    ...
                    if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) {
                        ...
                        $video_link = get_post_format_link( video );

                ?>
                    <div class="search-details" style="margin-top: 48px !important;">
                        <h3 class="color1" style="display:block;line-height:30%;letter-spacing:.5px;font-weight:bold;"><?php echo do_shortcode('[icon icon="icon-video-3" size="18" align="none" color="black" url="' . $video_link . '" new_window="no"]'); ?><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
