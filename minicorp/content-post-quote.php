            ...
            <div class="lined-section-only" style="white-space: nowrap;"><span style=""></span></div>
                ...
                ?>
                    <div class="search-details" style="margin-top: 48px !important;">
                        <h3 class="color1" style="display:block;line-height:30%;letter-spacing:.5px;font-weight:bold;"><?php echo do_shortcode('[icon icon="icon-quote-right" size="18" align="none" color="black" url="' . $quote_link . '" new_window="no"]'); ?><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                        ...
                        if ('' != $quote){
                            echo '<blockquote class="color2 post-quote-content" style="width:90%;display:inline-block;">';
                            echo $quote;
